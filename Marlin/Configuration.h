...
#define STRING_CONFIG_H_AUTHOR "(Connor Contursi)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Contursi Cube"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 31, -6, -3.5 }
...
#define Z_PROBE_LOW_POINT          -3.5 // Farthest distance below the trigger-point to go before stopping
...
#define X_MIN_POS -142.5
#define Y_MIN_POS -152.5
#define Z_MIN_POS 0
#define X_MAX_POS 142.5
#define Y_MAX_POS 152.5
